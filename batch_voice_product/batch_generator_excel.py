...
class ExcelTTSGenerator:
    ...
    def _setup_logging(self):
        """配置日志系统"""
        log_dir = self.config["paths"]["output_root"] / "logs"
    ...
    def generate_output_path(self, row, process_time):
        ...
        path_parts = [
            ...
            date_str,
            custom_prefix,
            f"{Path(row['参考音频路径']).stem}_{process_time:%H%M%S}.wav"
        ]
